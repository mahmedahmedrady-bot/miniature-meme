...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO products (name, code, description, category_id, cost_price, selling_price, quantity, min_quantity) 
                              VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$name, $code, $description, $category_id, $cost_price, $selling_price, $quantity, $min_quantity]);
...
<div class="container mx-auto max-w-2xl">
    <div class="bg-white rounded-lg shadow-lg p-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">إضافة منتج جديد</h1>
